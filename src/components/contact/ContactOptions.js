...
const ContactOptions = () => {
  ...
  const SendMail = (e) => {
    ...
    setMessage("SENDING");
    fetch("https://caffe-back.herokuapp.com/mail-contact", {
      method: "POST",
    ...
    <ContactOptionsContainer>
      ...
      <div className="ContactForm">
        ...
        <form>
          <label>Name:</label>
          <input
            className="InputContact NameInput"
            name="name"
            type="text"
          ...
          <label>Email:</label>
          <input
            className="InputContact NameEmail"
            name="email"
            type="email"
          ...
          <input
            className="InputContact NameTel"
            name="tel"
            type="tel"
          ...
          <label>Message:</label>
          <textarea
            className="InputContact NameMessage"
            name="message"
