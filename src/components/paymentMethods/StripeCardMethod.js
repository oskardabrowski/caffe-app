...
const stripePromise = loadStripe(
  "pk_test_51IfrSnFRZt7FtZ9TkBwHYG7WiX2nnzMKxEQ9TwQI7qlwjtzofZozvqXRWv4JGYo6KRbMayqiQM1DIIsfWOe5ZBze00aZqB0dnv"
);
...
export default function Stripe({ clientData }) {
  ...
  useEffect(() => {
    ...
    fetch("https://caffe-back.herokuapp.com/create-payment-intent", {
      method: "POST",
